...
public class DeviceTypeCheckerModule extends ReactContextBaseJavaModule {

    public DeviceTypeCheckerModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    public String getName() {
        return "DeviceTypeCheckerModule";
    }
}
